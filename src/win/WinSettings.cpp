...
LRESULT CALLBACK SettingsWndProc (HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) {
    switch (msg) {
        case WM_CREATE: {
            ...
            CreateWindow("STATIC", "Target Key:", WS_VISIBLE | WS_CHILD,20, 20, 150, 20, hwnd, NULL, NULL, NULL);
            CreateWindow("BUTTON", "Change", WS_VISIBLE | WS_CHILD,200, 15, 100, 30, hwnd, (HMENU)1, NULL, NULL);

            CreateWindow("STATIC", "Lock Key:", WS_VISIBLE | WS_CHILD,20, 60, 150, 20, hwnd, NULL, NULL, NULL);
            CreateWindow("BUTTON", "Change", WS_VISIBLE | WS_CHILD,200, 55, 100, 30, hwnd, (HMENU)2, NULL, NULL);

            CreateWindow("STATIC", "Unlock Key:", WS_VISIBLE | WS_CHILD,20, 100, 150, 20, hwnd, NULL, NULL, NULL);
            CreateWindow("BUTTON", "Change", WS_VISIBLE | WS_CHILD,200, 95, 100, 30, hwnd, (HMENU)3, NULL, NULL);

            CreateWindow("BUTTON", "Run on startup",WS_VISIBLE | WS_CHILD | BS_CHECKBOX,20, 140, 200, 20, hwnd, (HMENU)4, NULL, NULL);

            if (GetRunOnStartup()) {
                SendDlgItemMessage(hwnd, 4, BM_SETCHECK, BST_CHECKED, 0);
            }

            CreateWindow("BUTTON", "Close", WS_VISIBLE | WS_CHILD,120, 180, 100, 30, hwnd, (HMENU)10, NULL, NULL);
        }
        break;
...
void OpenSettingsWindow (HINSTANCE hInstance, HWND parent) {
    ...
    hWndSettings = CreateWindow("SplitLoafSettings","Split Loaf Settings",WS_OVERLAPPEDWINDOW & ~WS_MAXIMIZEBOX & ~WS_THICKFRAME,CW_USEDEFAULT, CW_USEDEFAULT,360, 260,parent, NULL, hInstance, NULL);
